...
import (
	...
	"github.com/evmos/evmos/v9/x/erc20/client/rest"
)
...
var (
	...
	UpdateRegisterCoinProposalHandler    = govclient.NewProposalHandler(cli.NewUpdateRegisterCoinProposalCmd, rest.UpdateRegisterCoinProposalRESTHandler)
)
