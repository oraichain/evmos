...
func (suite *KeeperTestSuite) TestAckknowledgementPacket() {
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				addr, err := sdk.AccAddressFromBech32("oraie16yefkqyzshnrvz4sxzufndyfphnkajs9rmhrht")
				suite.Require().NoError(err)

				mockpacket.Data = transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "oraie16yefkqyzshnrvz4sxzufndyfphnkajs9rmhrht",
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	senderStr := "oraie1pda2qlyjfn7k56s6hr5vh8vz3j3jnah4fyx4s3"
	receiverStr := "oraie16yefkqyzshnrvz4sxzufndyfphnkajs9rmhrht"
