...
var (
	now  = time.Now().UTC()
	acc1 = sdk.MustAccAddressFromBech32("oraie1pda2qlyjfn7k56s6hr5vh8vz3j3jnah4fyx4s3")
	acc2 = sdk.MustAccAddressFromBech32("oraie16yefkqyzshnrvz4sxzufndyfphnkajs9rmhrht")
)
